...
# Give full permissions to the uploads folder and make www-data the owner
RUN chown -R www-data:www-data /var/www/html/tkn/handlers/uploads
RUN chmod -R 777 /var/www/html/tkn/handlers/uploads
